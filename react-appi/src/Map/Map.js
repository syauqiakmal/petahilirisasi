...
export const Map = ({ hideComponents }) => {
  ...
  //     try {
  //       const dataResponse = await fetch(
  //         `http://localhost:8000/data/indo_districts`
  //       );
  //       if (!dataResponse.ok) {
  //         throw new Error("Failed to fetch shapefile data");
  //       }
  ...
  //         `http://localhost:8000/raster/image_export_m00_geometrynikel`
  //       );
  //       if (!response.ok) {
  //         throw new Error("Failed to fetch raster data");
  //       }
  ...
  //     try {
  //       const response = await fetch(
  //         `http://localhost:8000/raster/image_export_m05_geometrynikel`
  //       );
  //       if (!response.ok) {
  //         throw new Error("Failed to fetch raster data");
  //       }
  ...
  //     try {
  //       const response = await fetch(
  //         `http://localhost:8000/raster/image_export_m10_geometrynikel`
  //       );
  //       if (!response.ok) {
  //         throw new Error("Failed to fetch raster data");
  //       }
  ...
  //     try {
  //       const response = await fetch(
  //         `http://localhost:8000/raster/image_export_m15_geometrynikel`
  //       );
  //       if (!response.ok) {
  //         throw new Error("Failed to fetch raster data");
  //       }
  ...
  //     try {
  //       const response = await fetch(
  //         `http://localhost:8000/raster/image_export_m20_geometrynikel`
  //       );
  //       if (!response.ok) {
  //         throw new Error("Failed to fetch raster data");
  //       }
  ...
  useEffect(() => {
    const fetchRaster = async () => {
      try {
        const response = await fetch(
          `http://localhost:8000/raster/image_export_mchange_geometrynikel`
        );
        if (!response.ok) {
          throw new Error("Failed to fetch raster data");
        }
